        ...
        <nav className='lnb'>
            <ul>
                <li>
                  ...
                  >main</NavLink></li>
                <li><NavLink to="/coins" className={({isActive})=> isActive ? "hello" : ""}>coins</NavLink></li>
                <li><NavLink to="/posts" className={({isActive})=> isActive ? "hello" : ""}>게시판</NavLink></li>
                <li><NavLink to="/host" className={({isActive})=> isActive ? "hello" : ""}>host</NavLink></li>
                <li>
                    {
                        !user 
                        ? <NavLink to="/login"
